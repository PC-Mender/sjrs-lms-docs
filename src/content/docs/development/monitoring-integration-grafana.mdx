...
```ts
"connect-src 'self' http://localhost:* https://localhost:* ws://localhost:* wss://localhost:* https://www.google-analytics.com https://challenges.cloudflare.com https://your-frontend-domain.com https://your-grafana-collector-endpoint.grafana.net",
```
