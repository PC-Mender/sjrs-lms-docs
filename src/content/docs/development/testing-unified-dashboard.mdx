...
This testing guide was for the pilot phase. The unified dashboard is now production — the `VITE_USE_UNIFIED_DASHBOARD` feature flag and legacy implementations have been removed. All roles use `/dashboard` with role-based lazy-loaded views.
</Aside>
