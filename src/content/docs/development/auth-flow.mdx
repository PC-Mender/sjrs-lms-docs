...
## Role-Based Routing
- Public routes (`/`, `/home`, `/login`, `/register`, `/forgot-password`, `/reset-password`, `/email-confirmation`, `/resend-confirmation`) redirect authenticated users to `/dashboard`.
- Dashboard rendering is role-aware inside the unified dashboard entrypoint (`/dashboard/*`).
- Legacy role-prefixed dashboard URLs (`/dashboard-superuser/*`, `/dashboard-admin/*`, `/dashboard-librarian/*`, `/dashboard-dean/*`, `/dashboard-user/*`) are preserved as compatibility redirects to `/dashboard/*`.
