...
* **Reference Materials**: Manage non-circulating items.
    ...
    *   Track status (Available, In Use, Under Maintenance, Lost, Deprecated).
...
* **Create Guest**:
    *   Add new guests with first name, last name, email, and optional phone number.
    *   Guests are assigned the Guest role automatically.
    *   Set account status (Active, Inactive).

## Quick Links
* [Task Index](/user-guides/task-index): Step-by-step instructions for common tasks.
* [Glossary](/getting-started/glossary): Definition of system terms and roles.
