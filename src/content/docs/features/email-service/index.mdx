...
###  Email Operations
- **[Email Trigger Frequency Matrix](./email-trigger-frequency-matrix)** - Code-synced reference for when each email is sent and general send frequency
...
- Use [Email Trigger Frequency Matrix](./email-trigger-frequency-matrix) to understand trigger timing and expected send counts
