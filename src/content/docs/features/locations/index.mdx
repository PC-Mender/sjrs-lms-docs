...
The backend exposes a set of RESTful endpoints under `/api/v1/locations` that provide hierarchical data access:
...
| :--- | :--- | :--- | :--- |
| `GET` | `/api/v1/locations/countries` | None | Returns a list of all supported countries. |
| `GET` | `/api/v1/locations/states` | `?country=CODE` | Returns states for the specified country code. |
| `GET` | `/api/v1/locations/cities` | `?country=CODE&state=CODE` | Returns cities for the specified state and country. |
| `GET` | `/api/v1/locations/districts` | `?country=CODE&state=CODE` | Returns districts for the specified state (if supported). |
