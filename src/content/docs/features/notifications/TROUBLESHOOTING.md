...
curl -X OPTIONS https://your-worker.your-subdomain.workers.dev/api/notifications/events/ingest

# Test with GET (should return 405)
curl -X GET https://your-worker.your-subdomain.workers.dev/api/notifications/events/ingest
```
