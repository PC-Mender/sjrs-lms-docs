...
**Primary**: [`src/constants/user-status.ts`](https://github.com/PC-Mender/sjrslms/blob/main/src/constants/user-status.ts)
...
**Location**: [`src/utilities/status/status-utils.tsx`](https://github.com/PC-Mender/sjrslms/blob/main/src/utilities/status/status-utils.tsx)
...
**Location**: [`functions/middleware/validation/schemas/common-schemas.ts`](https://github.com/PC-Mender/sjrslms/blob/main/functions/middleware/validation/schemas/common-schemas.ts)
