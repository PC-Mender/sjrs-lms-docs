...
All status values are defined in [`src/constants/user-status.ts`](https://github.com/PC-Mender/sjrslms/blob/main/src/constants/user-status.ts):
...
**Email Confirmation** ([`functions/api/auth/email-confirmation.ts`](https://github.com/PC-Mender/sjrslms/blob/main/functions/api/auth/email-confirmation.ts)):
```typescript
...
**Profile Completion** ([`src/pages/profile-completion/hooks/useProfileSubmission.ts`](https://github.com/PC-Mender/sjrslms/blob/main/src/pages/profile-completion/hooks/useProfileSubmission.ts)):
```typescript
...
**Admin Approval** ([`functions/api/users/handlers/update-user.ts`](https://github.com/PC-Mender/sjrslms/blob/main/functions/api/users/handlers/update-user.ts)):
```typescript
