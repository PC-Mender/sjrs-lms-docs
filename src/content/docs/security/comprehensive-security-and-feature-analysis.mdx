...
- **Updated Endpoints:** `/api/v1/books`, `/api/v1/roles`, `/api/v1/journals`, `/api/v1/loans`, `/api/v1/orders`, `/api/v1/reference-categories`, `/api/v1/reference-sections`
...
- **Location:** `functions/api/upload/base/upload-utils.ts`
...
- **Location:** `functions/middleware/auth/core/index.ts`
...
- **Report Types:**
  -  **Loan Reports** (`/api/v1/reports/loans`)
...
- **API Endpoints:**
  - `GET /api/v1/reports/loans` - Loan statistics and analytics
  - `GET /api/v1/reports/users` - User activity analytics
  - `GET /api/v1/reports/financial` - Financial/penalty analytics
  - `GET /api/v1/reports/popularity` - Book popularity analytics
- **Frontend:**
