...
### **Version 6.19.1** ⭐ **CURRENT** (April 4, 2026)

#### **Templates + Permissions + Loans**
- **Templates (6.19.0–6.19.1)**: Template usage is fully wired with regression tests; repetitive icons removed from templates.
- **Permissions (6.18.0)**: Added a declarative `usePermission()` hook for consistent permission checks in UI components.
- **Loans (6.16.0)**: Added loan renewal request approval/rejection workflow.
- **User Dashboard (6.18.3)**: Fixed active/overdue loan counts in user stats with progressive loading.

#### **Bookmarks + UX polish**
- **Bookmarks (6.15.0)**: Added folder support and improved mutation handling.
- **UI (6.14.0)**: Added cards-only view and inline header improvements.
