...
- **Instant-Close Modal Pattern (Project Policy — Required for all CRUD modals)**:
  ...
  - **Reference Implementations**:
    - [RoleListPage.tsx](https://github.com/PC-Mender/sjrslms/blob/main/src/pages/roles/RoleListPage.tsx) — First official implementation
    - [BorrowLimitList.tsx](https://github.com/PC-Mender/sjrslms/blob/main/src/pages/borrow-limits/BorrowLimitList.tsx) — Reference for patterns
    - [ProfessorsPage.tsx](https://github.com/PC-Mender/sjrslms/blob/main/src/pages/professors/index.tsx) — Complete CUD migration with optimistic updates
