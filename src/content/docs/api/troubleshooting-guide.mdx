...
curl -i -c cookies.txt -X POST "https://your-worker.your-subdomain.workers.dev/api/auth/force-logout-other-sessions" \
  -H "Content-Type: application/json" \
  -d '{
    "email": "user@example.com",
    "password": "password123"
...
curl -i -b cookies.txt "https://your-worker.your-subdomain.workers.dev/api/auth/csrf"
...
curl -b cookies.txt "https://your-worker.your-subdomain.workers.dev/api/auth/validate-session"
