...
5. **API Endpoint**
   - Verify endpoint: `https://your-worker.your-subdomain.workers.dev/api/notifications/events/ingest`
...
export DEPLOYMENT_URL="https://your-worker.your-subdomain.workers.dev"
