...
![SJRS LMS Registration Flow diagram showing the six steps from personal information to login](/images/registration-flow.svg)
...
**Support**: support@yourdomain.com | **Help Desk**: +1-XXX-XXX-XXXX
