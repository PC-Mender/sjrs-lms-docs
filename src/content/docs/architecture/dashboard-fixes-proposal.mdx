...
This was a proposal document. The dashboard has since been consolidated to a single `/dashboard` route, and API endpoints now use `/api/v1/` versioning. See [Routing System](../architecture/routing-system) for the current architecture.
</Aside>
